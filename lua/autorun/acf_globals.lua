...
ACF.DriverTorqueBoost   = 1				-- torque multiplier from having a driver
ACF.FuelRate            = 1						-- multiplier for fuel usage, 1.0 is approx real world
ACF.ElecRate            = 0.458						-- multiplier for electrics								--BEFORE to balance: 0.458
ACF.TankVolumeMul       = 1						-- multiplier for fuel tank capacity, 1.0 is approx real world

---------------------------------- Ammo Crate config ----------------------------------

ACF.CrateMaximumSize    = 1000
...
ACF.URANPower         = 95000
ACF.URANDensity       = 1.27
ACF.URANFrag          = 15500
ACF.URANBlastPen      = 45
ACF.URANFeatherExp    = 20
ACF.URANBlastPenetration  = 70000
...
ACF.NormalizationFactor = 0.10					-- at 0.1(10%) a round hitting a 70 degree plate will act as if its hitting a 63 degree plate, this only applies to capped and LRP ammunition.
...
ACE.MatCostTables = {
	Alum			= 1.25 * (0.8325 / 0.333),	--A 25% increase in cost for 60% reduction in weight.
	CHA				= 0.7 * (0.98 / 1.25),	--25% more heavy for a 30% reduction in cost.
	Cer				= 1.15 * (2.05 / 1.2),	--70% more protection per kg for a 15% increase in cost. Takes a ton of damage and evaporates if penetrated.
	ERA				= 0.8 * (2.5 / 2.0),
	Rub				= 1.25 * (0.05 / 0.2),
	Texto			= 1.2 * (0.5 / 0.35),
	RHA 			= 1
