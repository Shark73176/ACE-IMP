...
ACFTranslation.Sonar = {
	...
	"TINY sonar useful for helicopter dipping sonars. The only SONAR that can see 360 degrees. While the range is quite insignificant compared to other sonars it is remarkably light and tiny.",--Tiny Sonar (6)
...
ACFTranslation.ShellFUAPFSDS = {
	...
	"APFSDS produced with using some elements or is made of full of DU(depleted uran)." --Desc (2)

}

ACFTranslation.ShellFTAPFSDS = {
	"Full Tungsten Armour Piercing Fin-Stabilized Discarding Sabot", --AmmoName (1)
	"APFSDS produced with using some elements or is made of full of WHA(tungsten)." --Desc (2)
...
ACFTranslation.ShellNUCHE = {
	"Nuclear High Explosive", --AmmoName (1)
	"A shell filled with explosives, fragments when detonating on impact. " --Desc (2)
