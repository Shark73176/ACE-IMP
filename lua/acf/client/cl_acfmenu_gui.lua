...
local MainMenuIcon = "icons/sevsce.png"
...
--[[=========================
	...
	local Guns = HomeNode:AddNode( "Guns" , "icons/canon.png" ) --Guns folder
	...
	local Missiles = HomeNode:AddNode( "Missiles" , "icons/rocket.png" ) --Missiles folder
	...
	do
		...
		local Mobility    = HomeNode:AddNode( "Mobility" , "icons/engine.png" )	--Mobility folder
	...
	do
		...
		local sensors	= HomeNode:AddNode("Sensors" , "icons/radar.png") --Sensor folder name
